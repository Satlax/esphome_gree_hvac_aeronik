...
// Бит 0 в Байте 10 (Турбо)
enum turbo_mode_t: uint8_t {
  TURBO_BIT = 0x01 // Используем только бит для побитовых операций
};
...
  
  // Сеттеры для управления переключателями
...
  bool turbo_state_ = false; // Используем bool для состояния Турбо
  
