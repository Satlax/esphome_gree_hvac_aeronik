...
class GreeClimate : public climate::Climate, public uart::UARTDevice, public PollingComponent {
 ...
 private:
  ...
  bool display_state_ = true; // Состояние дисплея по умолчанию
  bool turbo_state_ = false; // Состояние турбо по умолчанию
  uint8_t swing_mode_ = AC_SWING_OFF; // Режим свинга по умолчанию
};
